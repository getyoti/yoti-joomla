...
CREATE TABLE IF NOT EXISTS `j_yoti_users` (
...
INSERT INTO `j_menu` (`menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`,  `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`)
VALUES ('main', 'Yoti', X'796F7469', '', 'yoti', 'index.php?option=com_yoti', 'component', 1, 1, 1, 10001, 0, '1970-01-01 00:00:00', 0, 1, 'class:component', 0, '{}', 43, 44, 0, '', 1);
