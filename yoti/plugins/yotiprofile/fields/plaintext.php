...
class JFormFieldPlaintext extends JFormField
{
    ...
    public function getInput()
    {
        ...
        $warningMsg = "<strong>Warning</strong>: You are about to link your <strong>" . $companyName . "</strong> account to your Yoti account.<br/> Click the box below to keep them separate.";
